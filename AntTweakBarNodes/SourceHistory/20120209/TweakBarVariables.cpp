...
Dictionary<String^, int>^ TweakBarVariables::GetDictionary(String^ type)
{
	if(type == "Toggle")
	{
		return this->FDictToggle;
	}
	else if(type == "Integer")
	{
		return this->FDictInteger;
	}
	else if(type == "Double")
	{
		return this->FDictDouble;
	}
	else if(type == "String")
	{
		return this->FDictString;
	}
	else if(type == "Color")
	{
		return this->FDictColor;
	}
	else if(type == "Direction")
	{
		return this->FDictDirection;
	}
	else if(type == "Quaternion")
	{
		return this->FDictQuaternion;
	}
	else if(type == "Separator")
	{
		return this->FDictSeparator;
	}else
	{
		return nullptr;
	}
